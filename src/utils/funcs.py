...
def controlled_crop_face(img,landmark=None,bbox=None,margin=False,crop_by_bbox=True,abs_coord=False,only_img=False,phase='train'):
	assert phase in ['train','val','test','test1','test2','test3','trainval']
	...
	if margin:
		...
		h0_margin*=2
		h1_margin*=2
	# elif phase=='train' or phase=='trainval':
