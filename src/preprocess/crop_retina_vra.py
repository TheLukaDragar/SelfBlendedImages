...
def facecrop(model,org_path,save_path,period=2):
...
if __name__=='__main__':
	...
	#open json called /ceph/hpc/data/st2207-pgp-users/ldragar/SelfBlendedImages/src/vra_metadata.json
	...
	for clip in tqdm(list(dataset['clips'].keys())):
		...
		facecrop(model,path_tovid,save_path=out_path,period=2)
