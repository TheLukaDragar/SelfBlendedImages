#!/bin/sh
#SBATCH --job-name=extract_dlib
#SBATCH --output=extract_dlib%j.out
#SBATCH --error=extract_dlib%j.err
#SBATCH --nodes=1
...
srun --nodes=1 --exclusive --gpus=1 --ntasks-per-node=1 --time=2-00:00:00 -p gpu python3 ./src/preprocess/crop_dlib__vra.py
